...
class TranscriptCredentialsTest(CourseTestCase):
    ...
    def test_302_with_anonymous_user(self):
        ...
        response = self.client.post(transcript_settings_url, content_type='application/json')
    ...
    def test_405_with_not_allowed_request_method(self):
        ...
        """
        transcript_settings_url = self.get_url_for_course_key(self.course.id)
        response = self.client.get(transcript_settings_url, content_type='application/json')
