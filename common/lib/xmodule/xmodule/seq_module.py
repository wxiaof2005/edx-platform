...
class SequenceModule(SequenceFields, ProctoringFields, XModule):
    ...
    def _student_view(self, context, banner_text=None):
        ...
        fragment = Fragment()
        is_user_authenticated = context.get('user_authenticated', False)
        params = {
            ...
            'disable_navigation': not is_user_authenticated,
        }
    ...
    def _render_student_view_for_items(self, context, display_items, fragment):
        ...
        for item in display_items:
            ...
            if is_user_authenticated:
                ...
                bookmarks_service.is_bookmarked(usage_key=usage_id)
